...
class EqptDetailsBag extends Dialog
{
    ...
    private onTouch(e:egret.TouchEvent):void
    {
        ...
        switch (e.target)
        {
            ...
            case this.m_UI.xz_itembtn_xiangqian:
                ...
                break;
            case this.m_UI.xz_itembtn_xiexia:  //这个是卖出
                var url:string = "http://"+GameManager.server["ip"]+":"+GameManager.server["port"];
                var param:string = "id=" + this.m_UI.xz_icon.data["id"] + "&type=0x0075&sid="+GameManager.SESSION_ID;
