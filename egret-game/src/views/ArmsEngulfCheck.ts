...
class ArmsEngulfCheck extends Dialog
{
    ...
    private onClick(e:egret.TouchEvent):void
    {
        ...
        var ronglian:ArmsEngulfDialog = DialogManager.findDialog(ArmsEngulfDialog, "ArmsEngulfDialog");
    ...
    public onUpdate():void
    {
        ...
        if(equips.length > 0)
        {
            ...
            temp.sort(function(x:Equip, y:Equip)
            {
                if(x.qly > y.qly) return 1;
                else if(x.qly == y.qly)
                {
