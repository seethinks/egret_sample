class ChargeDialog extends Dialog
{
    ...
    private m_UI:UICharge;

    private taskList1:egret.gui.List = new egret.gui.List();

    private dp:egret.gui.ArrayCollection = new egret.gui.ArrayCollection();

    private charges:any = {5:{"name":"￥5", "fee":5, "subject":"50元宝"}, 10:{"name":"￥10", "fee":10, "subject":"100元宝"},
    50:{"name":"￥50", "fee":50, "subject":"500元宝"}, 100:{"name":"￥100", "fee":100, "subject":"1000元宝"},
    500:{"name":"￥500", "fee":500, "subject":"5000元宝"}};
    ...
    public onUpdate():void
    {
        ...
        if(nVipTpl){
            ...
            var shop:ShopData = Main.player.m_shops["charge"];
            if(!shop){
                //初始充值商店
                shop = new ShopData();
                shop.type = "charge";
