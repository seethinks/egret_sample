...
var GamePrompt = (function (_super) {
    __extends(GamePrompt, _super);
    function GamePrompt() {
        _super.call(this);
    }
    GamePrompt.prototype.createChildren = function () {
        ...
        var str = "  ---- 他是一款放置类游戏！！！！超级简单，\n\n超级轻松，拒绝各种繁琐打怪！\n\n\n" + "  ---- 在这里打怪都是 →|自 动 的|← 从创建人物开始就\n\n会不停的自动打怪，获得经验、金币和装备。\n\n\n" + "  ---- 即使退出游戏也 →|不 会 停|← 随时再回到游戏就\n\n可以收获一堆经验金币和装备!\n\n\n" + "  ---- 怎么玩这个游戏？你所做的，只需要挑选最好的装\n\n备给你的人物和美人穿上，不断的战胜BOSS和其他玩\n\n家，最终达到实力的巅峰赢取白富美！";
        this.m_UI.help_label.text = str;
    };
    GamePrompt.prototype.onTouch = function (e) {
        this.hide();
    };
    GamePrompt.prototype.onUpdate = function () {
    };
    GamePrompt.prototype.show = function () {
        _super.prototype.show.call(this);
    };
    GamePrompt.prototype.hide = function () {
        _super.prototype.hide.call(this);
        DialogManager.open(ActivityDialog, "ActivityDialog");
    };
    return GamePrompt;
})(Dialog);
GamePrompt.prototype.__class__ = "GamePrompt";
