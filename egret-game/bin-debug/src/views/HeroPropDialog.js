...
var HeroPropDialog = (function (_super) {
    __extends(HeroPropDialog, _super);
    function HeroPropDialog() {
        _super.call(this);
        this.taskList1 = new egret.gui.List();
        this.dp = new egret.gui.ArrayCollection();
    }
    HeroPropDialog.prototype.createChildren = function () {
    ...
    HeroPropDialog.prototype.onTouch = function (e) {
        this.hide();
    };
    HeroPropDialog.prototype.onUpdate = function () {
        this.dp.removeAll();
        this.dp.addItem({ "text": "" });
        var sm = Main.player.m_heros.heros[Main.player.m_operateObjid];
        if (!sm)
            return;
        var text = "Lv." + sm.level + " " + sm.name + "[" + GameManager.JOB_NAME[sm.job] + "]";
        var color = 0x2753e5;
        var size = 18;
        ...
        this.dp.addItem({ "text": text, "color": color, "size": size });
        var rate = sm.armor / (Number(Number(10 * sm.level * sm.level) + Number(60 * sm.level + 240)) * 8);
    ...
    HeroPropDialog.prototype.show = function () {
        _super.prototype.show.call(this);
        this.onUpdate();
    };
    HeroPropDialog.prototype.hide = function () {
        _super.prototype.hide.call(this);
    };
    return HeroPropDialog;
})(Dialog);
HeroPropDialog.prototype.__class__ = "HeroPropDialog";
